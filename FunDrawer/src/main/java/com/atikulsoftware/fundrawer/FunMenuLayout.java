...
public class FunMenuLayout extends FrameLayout {
    ...
    public FunMenuLayout(Context context) {
        this(context, null);
    }

    public FunMenuLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FunMenuLayout(Context context, AttributeSet attrs, int defStyleAttr) {
